...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmxhZGFtaXRpYyIsImEiOiJja3A3YmQyZGYwNXZiMm5vMGVuemoyZzhlIn0.oyT5lsHwrZSgE9y7L_7MYQ';
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Loged in successfully');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Error loging out. Try again!');
...
var stripe = Stripe('pk_test_51J5TtfJyoSSpcFeY4uP6bmb4Z5aReQAmtKwF5HxctIFrLT3slT7YrpaCjWgE6I4VDvESzI1ueo7SipjewkaFSqJo004UtOoyT7');
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              document.querySelector('.btn--save-password').textContent = 'Uppdating...';
